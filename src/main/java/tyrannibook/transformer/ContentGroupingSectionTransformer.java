...
import tyrannibook.data.content.ListingContent;
import tyrannibook.data.content.PaddingContent.ContentRightPadding;
...
public class ContentGroupingSectionTransformer extends SectionTransformer {
	...
	protected boolean processPage(TyrannobookData book, GroupingBuilder builder, PageData page) {
