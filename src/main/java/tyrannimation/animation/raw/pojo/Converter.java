...
public class Converter {
	...
	public static RawTyrannomationModel fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(RawTyrannomationModel obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(RawTyrannomationModel.class);
		writer = mapper.writerFor(RawTyrannomationModel.class);
	}
