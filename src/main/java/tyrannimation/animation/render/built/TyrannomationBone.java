...
public class TyrannomationBone implements IAnimatedBone 
{
	public TyrannomationBone parent;

	public List<TyrannomationBone> childBones = new ArrayList<>();
	public List<TyrannomationCube> childCubes = new ArrayList<>();
