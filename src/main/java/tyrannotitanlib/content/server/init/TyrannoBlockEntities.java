...
{		
	...
	public static final BlockEntityType<CharmCrateBlockEntity> CRATE_BLOCK_ENTITY = TyrannoRegistries.create("crate_block_entity", BlockEntityType.Builder.of(CharmCrateBlockEntity::new, collectBlocks(CharmCrateBlock.class)).build(null));
