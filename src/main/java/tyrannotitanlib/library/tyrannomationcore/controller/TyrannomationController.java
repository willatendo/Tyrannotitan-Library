package tyrannotitanlib.library.tyrannomationcore.controller;
...
import tyrannotitanlib.library.tyrannomationcore.TyrannomationState;
...
import tyrannotitanlib.library.tyrannomationcore.event.CustomInstructionKeyframeEvent;
import tyrannotitanlib.library.tyrannomationcore.event.ParticleKeyFrameEvent;
import tyrannotitanlib.library.tyrannomationcore.event.SoundKeyframeEvent;
...
import tyrannotitanlib.library.tyrannomationcore.keyframe.BoneTyrannomationQueue;
...
import tyrannotitanlib.library.tyrannomationcore.keyframe.KeyFrameLocation;
...
import tyrannotitanlib.library.tyrannomationcore.util.Axis;
...
public class TyrannomationController<T extends ITyrannomatable> {
	...
	public void process(double tick, TyrannomationEvent event, List<IBone> modelRendererList, HashMap<String, Pair<IBone, BoneSnapshot>> boneSnapshotCollection, MolangParser parser, boolean crashWhenCantFindBone) {
		...
		if (this.animationState == TyrannomationState.TRANSITIONING && tick >= this.transitionLengthTicks) {
			this.shouldResetTick = true;
			this.animationState = TyrannomationState.RUNNING;
