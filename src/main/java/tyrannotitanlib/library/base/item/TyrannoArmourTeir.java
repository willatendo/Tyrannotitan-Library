...
public class TyrannoArmourTeir implements ArmorMaterial
{
	...
	public TyrannoArmourTeir(ResourceLocation name, int maxDamage, int[] damageReductionArray, int enchantability, Supplier<SoundEvent> equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairItem) 
	{
		this.name = name;
