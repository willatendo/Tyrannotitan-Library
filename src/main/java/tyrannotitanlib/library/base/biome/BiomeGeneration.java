...
public class BiomeGeneration {
	public static final ArrayList<TyrannoBiome> BIOMES = new ArrayList<>();

	// Copied from SurfaceRuleData
	...
	public static Builder<SurfaceRules.RuleSource> overworldLike(boolean b1, boolean b2, boolean b3) {
		...
		builder.add(b1 ? surfacerules$rulesource9 : surfacerules$rulesource8);
