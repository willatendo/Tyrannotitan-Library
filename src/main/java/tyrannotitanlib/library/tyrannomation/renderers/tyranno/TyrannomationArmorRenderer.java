...
public abstract class TyrannomationArmorRenderer<T extends ArmorItem & IAnimatable> extends BipedModel implements ITyrannomationRenderer<T> 
{
	...
	public TyrannomationArmorRenderer(AnimatedTyrannomationModel<T> modelProvider) 
	{
		super(1);
