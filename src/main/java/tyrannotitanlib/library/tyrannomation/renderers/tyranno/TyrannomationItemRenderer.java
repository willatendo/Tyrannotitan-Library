...
public abstract class TyrannomationItemRenderer<T extends Item & IAnimatable> extends ItemStackTileEntityRenderer implements ITyrannomationRenderer<T> 
{
	static 
	{
	...
	protected AnimatedTyrannomationModel<T> modelProvider;
	protected ItemStack currentItemStack;

	public TyrannomationItemRenderer(AnimatedTyrannomationModel<T> modelProvider) 
	{
		this.modelProvider = modelProvider;
	}

	public void setModel(AnimatedTyrannomationModel<T> model) 
	{
