...
public abstract class TyrannomationEntityRenderer<T extends LivingEntity & IAnimatable> extends EntityRenderer<T> implements ITyrannomationRenderer<T> 
{
	static 
	{
	...
	protected TyrannomationEntityRenderer(EntityRendererManager renderManager, AnimatedTyrannomationModel<T> modelProvider) 
	{
		super(renderManager);
