...
public abstract class TyrannoReplacedEntityRenderer<T extends IAnimatable> extends EntityRenderer implements ITyrannomationRenderer 
{
	private final AnimatedTyrannomationModel<IAnimatable> modelProvider;
	...
	private static Map<Class<? extends IAnimatable>, TyrannoReplacedEntityRenderer> renderers = new ConcurrentHashMap<>();
	...
	protected TyrannoReplacedEntityRenderer(EntityRendererManager renderManager, AnimatedTyrannomationModel<IAnimatable> modelProvider, T animatable) 
	{
		super(renderManager);
	...
	public static void registerReplacedEntity(Class<? extends IAnimatable> itemClass, TyrannoReplacedEntityRenderer renderer) 
	{
		renderers.put(itemClass, renderer);
	}

	public static TyrannoReplacedEntityRenderer getRenderer(Class<? extends IAnimatable> item) 
	{
	...
	@Override
	public AnimatedTyrannomationModel getGeoModelProvider() 
	{
