...
public class IndexTransformer extends TyrannobookTransformer {
	...
	public static final ResourceLocation INDEX_EXTRA_DATA = TyrannoUtils.rL("index");
	...
	private List<SectionData> getVisibleSections(@Nullable BookScreen.AdvancementCache advancementCache, TyrannobookData book) {
