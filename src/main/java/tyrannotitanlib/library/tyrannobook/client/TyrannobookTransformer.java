...
import tyrannotitanlib.library.tyrannobook.client.data.content.ContentSectionList;
import tyrannotitanlib.library.tyrannobook.client.data.content.ContentTableOfContents;
