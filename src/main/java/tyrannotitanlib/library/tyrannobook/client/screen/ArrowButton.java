...
public class ArrowButton extends Button {
	...
	public ArrowButton(TyrannobookData bookData, int x, int y, ArrowType arrowType, int color, int hoverColor, OnPress iPressable) {
	...
	public void renderButton(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks, TyrannobookData bookData) {
		Minecraft minecraft = Minecraft.getInstance();
		if (bookData != null) {
			RenderSystem.setShaderTexture(0, bookData.appearance.getBookTexture());
		} else {
			RenderSystem.setShaderTexture(0, BookTextures.TEX_BOOK);
		}
	...
	public void renderButton(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
		renderButton(matrixStack, mouseX, mouseY, partialTicks, this.bookData);
	}
