...
public class ContentCrafting extends PageContent {
	...
	public static final transient ImageData IMG_CRAFTING_LARGE = new ImageData(BookTextures.TEX_CRAFTING, 0, 0, 183, 114, TEX_SIZE, TEX_SIZE);
	public static final transient ImageData IMG_CRAFTING_SMALL = new ImageData(BookTextures.TEX_CRAFTING, 0, 114, 155, 78, TEX_SIZE, TEX_SIZE);
