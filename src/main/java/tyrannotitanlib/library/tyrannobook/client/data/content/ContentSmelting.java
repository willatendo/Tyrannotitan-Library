...
import tyrannotitanlib.library.tyrannobook.client.data.element.TooltipElement;
...
public class ContentSmelting extends PageContent {
	...
	public static final transient ImageData IMG_SMELTING = new ImageData(BookTextures.TEX_SMELTING, 0, 0, 110, 114, TEX_SIZE, TEX_SIZE);
