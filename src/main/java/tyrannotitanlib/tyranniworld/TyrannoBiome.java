...
public abstract class TyrannoBiome {
	...
	public static BiomeSpecialEffects.Builder builder() {
		return new BiomeSpecialEffects.Builder().fogColor(BASE_FOG_COLOUR).waterColor(BASE_WATER_COLOUR).fogColor(BASE_FOG_COLOUR);
	}
