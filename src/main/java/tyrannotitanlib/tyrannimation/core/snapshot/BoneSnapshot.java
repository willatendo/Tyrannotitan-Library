package tyrannotitanlib.tyrannimation.core.snapshot;

import tyrannotitanlib.tyrannimation.core.processor.IAnimatedBone;

public class BoneSnapshot {
	public String name;
	private IAnimatedBone modelRenderer;
	...
	public BoneSnapshot(IAnimatedBone modelRenderer) {
	...
	public BoneSnapshot(IAnimatedBone modelRenderer, boolean dontSaveRotations) {
