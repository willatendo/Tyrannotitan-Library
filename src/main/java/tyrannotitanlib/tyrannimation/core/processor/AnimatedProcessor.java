package tyrannotitanlib.tyrannimation.core.processor;
...
import tyrannotitanlib.tyrannimation.core.snapshot.DirtyTracker;
import tyrannotitanlib.tyrannimation.core.util.MathUtil;
...
public class AnimatedProcessor<T extends IAnimated> {
	...
	public void tickAnimation(IAnimated entity, Integer uniqueID, double seekTime, AnimationEvent event, MolangParser parser, boolean crashWhenCantFindBone) {
		...
		for (AnimationController<T> controller : manager.getAnimatedControllers().values()) {
