...
public class AnimationQuad {
	public AnimationVertex[] vertices;
	public final Vector3f normal;
	public Direction direction;

	public AnimationQuad(AnimationVertex[] verticesIn, float u1, float v1, float uSize, float vSize, float texWidth, float texHeight, Boolean mirrorIn, Direction directionIn) {
	...
	public AnimationQuad(AnimationVertex[] verticesIn, double[] uvCoords, double[] uvSize, float texWidth, float texHeight, Boolean mirrorIn, Direction directionIn) {
