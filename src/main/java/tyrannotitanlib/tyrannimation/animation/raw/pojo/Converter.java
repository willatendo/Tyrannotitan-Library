...
public class Converter {
	...
	public static RawAnimatedModel fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(RawAnimatedModel obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(RawAnimatedModel.class);
		writer = mapper.writerFor(RawAnimatedModel.class);
	}
