package tyrannotitanlib.tyrannimation.animation.raw.tree;
...
import tyrannotitanlib.tyrannimation.animation.raw.pojo.MinecraftGeometry;
...
public class RawGeometryTree {
	...
	public static RawGeometryTree parseHierarchy(RawAnimatedModel model) {
