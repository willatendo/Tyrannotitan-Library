...
import tyrannotitanlib.tyrannibook.client.data.element.ItemElement;
...
public class ContentSmithing extends PageContent 
{
	...
	public static final transient ImageData IMG_SMITHING = new ImageData(Textures.TEX_MISC, 88, 0, 210, 42, TEX_SIZE, TEX_SIZE);
