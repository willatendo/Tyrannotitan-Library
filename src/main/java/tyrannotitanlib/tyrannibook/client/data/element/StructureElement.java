...
import tyrannotitanlib.tyrannibook.client.structure.StructureInfo;
import tyrannotitanlib.tyrannibook.client.structure.world.TemplateWorld;
...
public class StructureElement extends SizedTyrannobookElement 
{
	...
	public StructureElement(int x, int y, int width, int height, Template template, List<Template.BlockInfo> structure) 
	{
		...
		this.additionalTransform = new TransformationMatrix(null, new Quaternion(25, 0, 0, true), null,
