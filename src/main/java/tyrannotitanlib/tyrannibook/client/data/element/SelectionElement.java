...
import tyrannotitanlib.tyrannibook.client.screen.TextDataRenderer;

public class SelectionElement extends SizedTyrannobookElement 
{
	...
	public void draw(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks, FontRenderer fontRenderer) 
	{
		...
		if(this.section.parent.appearance.drawSectionListText) 
		{
			...
			for(int i = 0; i < splitTitle.length; i++) 
			{
				...
				fontRenderer.draw(matrixStack, splitTitle[i], textX, textY, hover ? 0xFF000000 : 0x7F000000);
			}
		}
	}
