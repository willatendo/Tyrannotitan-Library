package tyrannotitanlib.tyrannibook.client.screen;
...
import tyrannotitanlib.tyrannibook.client.Textures;
...
import tyrannotitanlib.tyrannibook.client.data.element.ItemStackData;
...
public class TyrannobookScreen extends Screen 
{
	...
	public void render(MatrixStack stack, int mouseX, int mouseY, float partialTicks) 
	{
		...
		if(this.page == -1) 
		{
			render.bind(Textures.TEX_BOOKFRONT);
